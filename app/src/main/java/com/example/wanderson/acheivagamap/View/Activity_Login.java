...
/**
 * Created by Wanderson on 09/08/2017.
 */
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnLogin.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                dialog = ProgressDialog.show(Activity_Login.this, "Autenticando", "Autenticando usuário, por favor aguarde...", true, false);
                ...
                if (verificaConexao()) {
                    ...
                    Toast.makeText(Activity_Login.this, "Aparentemente você está sem conexão!", Toast.LENGTH_LONG).show();
                    dialog.dismiss();
                }
    ...
    */
    private void autenticarUsuario(String email, String password) {
        ...
        if((!email.equals(""))&&(!password.equals(""))){
                    ...
                    .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                        ...
                        public void onComplete(@NonNull Task<AuthResult> task) {
                            if (task.isSuccessful()) {
                                ...
                                Toast.makeText(Activity_Login.this, "Login efetuado com sucesso.",
                                        Toast.LENGTH_SHORT).show();
                                dialog.dismiss();
                                Intent intent = new Intent(Activity_Login.this, ActivityAdmin.class);
                                startActivity(intent);
                            } else {
                                dialog.dismiss();
                                Log.w(TAG, "signInWithEmail:failure", task.getException());
                                Toast.makeText(Activity_Login.this, "Login ou senha inválidos.",
            ...
            dialog.dismiss();
            Toast.makeText(Activity_Login.this, "É obrigatório o preenchimento dos campos E-mail e Senha.",
                    Toast.LENGTH_LONG).show();
        }
    }
